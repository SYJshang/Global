...
typedef enum {
    SDCycleScrollViewTitleLabelAlimntLeft,
    SDCycleScrollViewTitleLabelAlimntCenter,
    SDCycleScrollViewTitleLabelAlimntRight
} SDCycleScrollViewTitleLabelAlimnt;
...
/** 轮播文字label字体位置 */
@property (nonatomic, assign) SDCycleScrollViewTitleLabelAlimnt titleLabelTextAliment;
