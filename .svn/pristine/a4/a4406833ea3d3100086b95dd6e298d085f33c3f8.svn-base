...
- (void)_baseConfigs {
  ...
  _segmentControl.backgroundColor = [UIColor whiteColor];
    _segmentControl.tintColor = BackGray;
//    _segmentControl.tintColor = [UIColor clearColor];
//    [_segmentControl setBackgroundImage:[UIImage imageNamed:@"bg2"] forState:UIControlStateSelected barMetrics:UIBarMetricsDefault];
//    [_segmentControl setBackgroundImage:[UIImage imageNamed:@"bg1"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
...
//    _segmentControl.layer.borderColor = TextColor.CGColor;
...
//  _segmentControl.
  ...
  _bottomLine.backgroundColor = BackGray;
