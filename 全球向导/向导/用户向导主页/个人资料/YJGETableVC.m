...
#import "YJTimeCell.h"
#import "YJGEWroldMineVC.h"
#import "YJGuideInformationModel.h"


@interface YJGETableVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)setNetWork{
    ...
    [WBHttpTool GET:[NSString stringWithFormat:@"%@/mainGuide/findGuideDetail/%@",BaseUrl,self.ID] parameters:nil success:^(id responseObject) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 2) {
        [self.navigationController pushViewController:[YJGEWroldMineVC new] animated:YES];
    }
