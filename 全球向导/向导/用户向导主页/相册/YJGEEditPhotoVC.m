...
@interface YJGEEditPhotoVC ()<UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate,SDPhotoBrowserDelegate>{
...
@implementation YJGEEditPhotoVC
...
- (void)getPhotoLsit{
    ...
    [WBHttpTool Post:[NSString stringWithFormat:@"%@/mainGuide/listAlbumPic",BaseUrl] parameters:parameter success:^(id responseObject) {
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    return self.photoLsitArr.count;
}
