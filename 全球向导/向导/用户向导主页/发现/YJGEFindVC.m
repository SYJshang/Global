...
@interface YJGEFindVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)getNetWork{
    ...
    [parameter setObject:self.ID forKey:@"guideId"];
    [WBHttpTool GET:[NSString stringWithFormat:@"%@/mainGuideRec/listByGuideId",BaseUrl] parameters:parameter success:^(id responseObject) {
