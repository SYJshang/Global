...
@interface YJMineEvaluateVC ()<SGTopTitleViewDelegate, UIScrollViewDelegate>
...
@implementation YJMineEvaluateVC
...
- (void)viewDidLoad {
    ...
    YJEveWiatVC *oneVC = [[YJEveWiatVC alloc] init];
...
- (void)setupChildViewController {
    ...
    // 已评价
    YJAlreadyEveVC *twoVC = [[YJAlreadyEveVC alloc] init];
