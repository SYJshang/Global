...
@interface YJRanKDetailVC ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)getUserInfo{
    ...
    [WBHttpTool Post:[NSString stringWithFormat:@"%@/guide/gv/list",BaseUrl] parameters:nil success:^(id responseObject) {
        ...
        if ([dict[@"code"] isEqualToString:@"1"]) {
            ...
            self.totalCout = [YJRankDetailModel mj_objectArrayWithKeyValuesArray:dict[@"data"][@"gvDetailList"]];
            self.pageModel = [YJPageModel mj_objectWithKeyValues:dict[@"data"][@"queryGvDetail"][@"page"]];
...
- (void)getMoreData{
    ...
    [WBHttpTool Post:[NSString stringWithFormat:@"%@/guide/gv/list",BaseUrl] parameters:parmeter success:^(id responseObject) {
        ...
        if ([dict[@"code"] isEqualToString:@"1"]) {
            ...
            self.orderList = [YJRankDetailModel mj_objectArrayWithKeyValuesArray:dict[@"data"][@"gvDetailList"]];
            self.pageModel = [YJPageModel mj_objectWithKeyValues:dict[@"data"][@"queryGvDetail"][@"page"]];
