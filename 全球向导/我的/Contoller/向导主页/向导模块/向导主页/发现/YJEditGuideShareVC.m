...
@interface YJEditGuideShareVC ()<UIWebViewDelegate>{
    UIWebView *webView;
...
@implementation YJEditGuideShareVC
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/guide/guideRec/toUpdate/%@",BaseUrl,self.ID]];
