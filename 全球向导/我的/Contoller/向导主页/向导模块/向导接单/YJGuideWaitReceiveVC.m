...
@interface YJGuideWaitReceiveVC ()<UITableViewDelegate,UITableViewDataSource,DisAndReceingClickPush>
...
@implementation YJGuideWaitReceiveVC
...
- (void)getNetWorkData{
    ...
    [parameter setObject:@"7" forKey:@"status"];
