...
- (void)setupToolbars
{
    ...
    deleteBtn.backgroundColor = [UIColor colorWithRed:0.1f green:0.1f blue:0.1f alpha:0.90f];
...
- (void)layoutSubviews
{
    ...
    _deleteBtn.frame = CGRectMake(self.bounds.size.width - 80, self.bounds.size.height - 70, 50, 25);
}
