...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell.hasConfigured) {
        ...
        switch (self.titleLabelTextAliment) {
            case SDCycleScrollViewTitleLabelAlimntLeft:
                cell.titleLabel.textAlignment = NSTextAlignmentLeft;
                break;
            case SDCycleScrollViewTitleLabelAlimntRight:
                cell.titleLabel.textAlignment = NSTextAlignmentRight;
                break;
            case SDCycleScrollViewTitleLabelAlimntCenter:
