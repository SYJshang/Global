...
#define selectedTitleAndIndicatorViewColor TextColor
...
- (void)setStaticTitleArr:(NSArray *)staticTitleArr {
    ...
    for (NSInteger j = 0; j < self.staticTitleArr.count; j++) {
        ...
        _staticTitleLabel.textColor = [UIColor colorWithRed:(102 / 255.0) green:(102 / 255.0) blue:(102 / 255.0) alpha:1.0];
        _staticTitleLabel.font = [UIFont systemFontOfSize:AdaptedWidth(15.0)];
...
- (void)staticTitleLabelSelecteded:(UILabel *)label {
    ...
    // 颜色恢复
    _selectedTitleLabel.textColor = [UIColor colorWithRed:(102 / 255.0) green:(102 / 255.0) blue:(102 / 255.0) alpha:1.0];
